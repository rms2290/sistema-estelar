# Cópia de django.contrib.admin.migrations.0001_initial com dependência explícita
# em notas.0016_usuario para que o modelo Usuario exista antes do admin (evita
# "Related model 'notas.usuario' cannot be resolved" ao rodar testes).
...
class Migration(migrations.Migration):
    dependencies = [
        ("notas", "0016_usuario"),  # Usuario deve existir antes do LogEntry
